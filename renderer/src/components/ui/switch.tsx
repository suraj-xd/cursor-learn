...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      data-slot="switch"
      className={cn(
        // Add a visible border for both light and dark
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          // Make sure the thumb is always visible
          "bg-foreground dark:bg-foreground dark:data-[state=checked]:bg-primary-foreground pointer-events-none block size-4 rounded-full ring-0 transition-transform data-[state=checked]:translate-x-[calc(100%-2px)] data-[state=unchecked]:translate-x-0 border border-border"
        )}
      />
    </SwitchPrimitive.Root>
  )
